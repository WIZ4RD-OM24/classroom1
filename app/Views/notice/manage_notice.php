      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <a style="margin-left:820px; width:100px;" href="<?php echo base_url('/view-add-notice');?>"
             class="btn btn-success mb-2">Add Notice</a>
            ...
            <?php foreach($notices as $notice): ?>   
              <div class="card ">
                ...
                <div class="card-footer inline">
                  ...
                  <a style="margin-left:440px" href="<?php echo base_url('view-notice/'.$notice['notice_id']);?>" class="btn btn-primary mb-2"><i class="fas fa-eye"></i></a>&nbsp;&nbsp;
