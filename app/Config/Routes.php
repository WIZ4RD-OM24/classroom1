...
$routes->get('/view-add-subject','SubjectController::view_add_subject');
...
$routes->get('/view-post-assignment','AssignmentController::view_post_assignment');


//-----------------TEACHER ROUTES------------------------
$routes->get('/teachers','TeacherController::index',['filter' => 'authGuard']);
$routes->get('/add-teacher','TeacherController::add_teacher');
$routes->get('/view-add-teacher',function(){session(); return view('teacher/add_teacher');});
...
$routes->get('/view-add-notice','NoticeController::view_add_notice');
